    ...
    <div className="legal-root">
      ...
      <div className="legal-main-content">
        <header className="legal-header">
          <h1 className="legal-header-title">Политика конфиденциальности</h1>
        </header>
        <div className="legal-container">
          <div className="legal-card">
            <div className="legal-subtitle">Правовая информация.</div>
            <p className="legal-text">Политика в отношении обработки персональных данных</p>
            <div className="policy-text" style={{ whiteSpace: "pre-wrap", lineHeight: 1.6 }}>
                {/* Вставьте текст Политики конфиденциальности ниже. Можно заменить на ваш готовый текст. */}
                <h4>
                
                </h4>
                <p>
                <h4>1. Общие положения</h4>
                Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые <b>администрацией сервиса Melot Tech</b> (далее — Оператор).
                ...
                <br/>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://melot.tech.
                ...
                <br/>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://melot.tech.
                ...
                <br/>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://melot.tech.
                ...
                <br/>2.10. Пользователь — любой посетитель веб-сайта https://melot.tech.
                ...
                <br/>— номера телефонов
                <br/>— фамилия и имя
                <br/>— телеграм идентификатор
                <br/>Правовые основания:	
                <br/>— Согласие субъекта персональных данных на обработку
                ...
                <br/>— Передача между пользователями сервиса персональных данных в целях организации записи
                <br/>Цель обработки отправка уведомлений через мессенджер Telegram о новых записях, изменениях расписания
                <br/>Персональные данные:
                <br/>— номера телефонов
                <br/>— фамилия и имя
                <br/>— телеграм идентификатор
                ...
                <br/>— Согласие субъекта персональных данных на обработку
                <br/>Виды обработки персональных данных:
                <br/>— Передача системных уведомлений
                ...
                <br/>8.1. Оператор обеспечивает сохранность персональных данных и принимает все необходимые меры, включая шифрование передаваемых данных, регулярное обновление программного обеспечения и ограничение доступа к базам данных.
                <br/>8.2. Персональные данные передаются другим пользователям сервиса исключительно в целях организации записи, в объеме, необходимом для идентификации в расписании(имя, фамилия). Номер телефона и Telegram ID не передаются.
                <br/>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора __ с пометкой «Актуализация персональных данных».
                ...
                <br/>Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора __ с пометкой «Отзыв согласия на обработку персональных данных».
                <br/>8.5. Сервис интегрирован с Telegram Messenger для отправки уведомлений о записях и изменениях расписания. При авторизации через Telegram передается только Telegram ID, номер, имя и фамилия пользователя.Обработка данных через Telegram регулируется политикой конфиденциальности Telegram (https://telegram.org/privacy).
                ...
                12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты __.
                ...
                <br/>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://melot.tech/privacy/.
                <br/>12.4. Оператор обязуется рассмотреть обращения и запросы субъектов персональных данных в срок не позднее 30 дней с момента получения.
                <h4>13. Использование файлов cookies</h4>
                13.1. Веб-сайт использует файлы cookies для обеспечения функционирования сервиса, анализа посещаемости и улучшения пользовательского опыта.
                <br/>13.2. Продолжая использование сайта, Пользователь соглашается с использованием файлов cookies.
